...
namespace HighFlowStorage
{
    ...
    public class HighFlowLiquidReservoirVerticalConfig2 : IBuildingConfig
    {
        public const string ID = "Nightinggale.HighFlowLiquidVerticalReservoir2";

        private const string DisplayName = "High Flow Vertical Liquid Reservoir";
        public const string Description = "";
        public const string Effect = "For people where one pipe just isn't enough.";

        private static readonly PortDisplayInput inputPort0 = new PortDisplayInput(ConduitType.Liquid, new CellOffset(0, 0), new CellOffset(0, 2));
        private static readonly PortDisplayInput inputPort1 = new PortDisplayInput(ConduitType.Liquid, new CellOffset(1, 0), new CellOffset(1, 2));

        private static readonly PortDisplayOutput outputPort0 = new PortDisplayOutput(ConduitType.Liquid, new CellOffset(0, 2), new CellOffset(0, 0));
        private static readonly PortDisplayOutput outputPort1 = new PortDisplayOutput(ConduitType.Liquid, new CellOffset(1, 2), new CellOffset(1, 0));
